...
namespace Game.Debate
{
    public class DebateRoundManager : MonoBehaviour
    {
        ...
        private string refereeOpeningLine =
            "Welcome, everyone. Today's debate topic is: {0} Berance will begin with the opening argument. The debate begins.";
        ...
        private IEnumerator RunRound()
        {
            ...
            if (sendOpponentOpeningPrompt && opponentNPC != null)
            {
